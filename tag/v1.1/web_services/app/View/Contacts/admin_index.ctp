<div class="contacts index content-without-left-menu">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $contact['Contact']['id']),array('class'=>'delete-icon','title'=>'Delete'), null, __('Are you sure you want to delete # %s?', $contact['Contact']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
