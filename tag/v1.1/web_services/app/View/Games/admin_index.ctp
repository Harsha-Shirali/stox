<div class="games index content-with-left-menu">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('default_net_value'); ?></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $game['Game']['id']),array('class'=>'delete-icon','title'=>'Delete'), null, __('Are you sure you want to delete # %s?', $game['Game']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
