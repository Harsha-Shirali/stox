<div class="userStocks index content-with-left-menu">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $userStock['UserStock']['id']),array('class'=>'delete-icon','title'=>'Delete'), null, __('Are you sure you want to delete # %s?', $userStock['UserStock']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
