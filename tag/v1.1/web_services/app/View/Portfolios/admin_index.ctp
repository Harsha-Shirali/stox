<div class="portfolios index content-with-left-menu">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $portfolio['Portfolio']['id']),array('class'=>'delete-icon','title'=>'Delete'), null, __('Are you sure you want to delete # %s?', $portfolio['Portfolio']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
