...
<!--            <dt><?php echo __('Created'); ?></dt>
            ...
            <dd>
                ...
                <?php if ($user['User']['modified'] != 0) { ?>
                    <?php echo h(date('M d, Y H:i:s', strtotime($user['User']['modified']))); ?>
                <?php } else { ?>
                    ---
                <?php } ?>
                &nbsp;
...
<!--                    <td>
                        <?php if ($portfolio['created'] != 0) { ?>
                            <?php echo h(date('M d, Y H:i:s', strtotime($portfolio['created']))); ?>
                        <?php } else { ?>
                            ---
                        <?php } ?>
                    </td>
                    <td>
                        <?php if ($portfolio['modified'] != 0) { ?>
                            <?php echo h(date('M d, Y H:i:s', strtotime($portfolio['modified']))); ?>
                        <?php } else { ?>
                            ---
                        <?php } ?>
                    </td>-->
    ...
    foreach ($user['UserLog'] as $userLog):
        ?>
                                                <tr>
                                                        ...
                                                        <td><?php echo date('M d, Y H:i:s', strtotime($userLog['created'])); ?></td>
                                                        <td><?php echo date('M d, Y H:i:s', strtotime($userLog['modified'])); ?></td>
                                                         <td class="actions">
