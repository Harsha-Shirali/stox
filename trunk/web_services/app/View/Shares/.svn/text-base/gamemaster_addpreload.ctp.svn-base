    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($shares as $share): ?>
            <tr>
                ...
                <td class="actions">
                    <?php //echo $this->Form->postLink(__(''), array('action' => 'add', $share['Share']['id']), array('class' => 'edit-icon', 'title' => 'Add'), __('Are you sure you want to add?', $share['Share']['id'])); ?>
             ...
             <?php //echo $this->Form->postLink(__(''), array('action' => 'delete', $share['Share']['id']), array('class' => 'delete-icon', 'title' => 'Delete'), __('Are you sure you want to delete?', $share['Share']['id'])); ?>
