            ...
            if($this->save($data)){
                ...
                if($data['type'] == 'trade'){
                    $this->Portfolio->updateAll(
                                array('Portfolio.trades' =>  'Portfolio.trades + '.$assets,'Portfolio.start_trade' =>  'Portfolio.start_trade + '.$assets),
                    ...
                    $this->Portfolio->updateAll(
                                ...
                                array('Portfolio.net_value' =>  'Portfolio.net_value + '.$assets,'Portfolio.start_money' =>  'Portfolio.start_money + '.$assets,),
                                array('Portfolio.id' => $data['portfolio_id'])
                            );
                }
