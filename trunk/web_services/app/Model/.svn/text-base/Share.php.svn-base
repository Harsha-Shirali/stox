	...
	function fetchData($start, $no_of_record, $search)
	{
		...
		if ($search != '')
		{
			...
			$conditions[] = array(
				...
				'or' => array(
				array('Share.symbol' => trim($search),
				'Share.symbol NOT LIKE' => '$%'),
				array('Share.exchange_id' => $exchange_ids))
				/*
				 'OR' => array(
				 array('Share.symbol LIKE ' => '%' . $search . '%'),
				 array('Share.symbol NOT LIKE' => '$%'),
				 array('Share.exchange_id' => $exchange_ids)
				 )*/
		...
		$this -> virtualFields = array(
			...
			/*
			 "full_name": null,
			 "symbol": "$NQGB2700AUDN",
			 "todays_closing_price": null,
			 "open_price": "1107.05",
			 "previous_close_price": "1098.85",
			 "days_high_price": "1107.05",
			 "days_low_price": "1107.05",
			 "bid_price": null,
			 "ask_price": null,
			 "exchange_id": "4",
			 "quantity": "5",
			 "exchange_name": "NY",
			 "exchange_full_name": "New York Stock Exchange",
			 "share_id": "1"
			 */
			'share_id' => 'Share.id',
