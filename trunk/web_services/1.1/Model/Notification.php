...
class Notification extends AppModel {
    ...
    /**
     * @author Ganesh
     * @uses This function is used to get all notification from the table
     */
    ...
    /**
     * @author Ganesh
     * @uses This function is used as a pagination
     */
    ...
    /**
     * @author Ganesh
     * @uses This function is used to find unread notification count
     */
    ...
    /**
     * @author Ganesh
     * @uses This function is used to retrieve all push token of the users and sending ios notification
     */
    function sendNotificationsToUsers($push_msg) {
        ...
        foreach ($getValues as $values) {
            if (!empty($values["user_logs"]["push_note_token"])) {
                ...
                $apiComponent->send_ios_notification($deviceToken, $push_msg);
            }
        }
    }
