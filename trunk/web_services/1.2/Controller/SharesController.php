...
class SharesController extends AppController {
     ...
     * @copyright Softway solutions
     * @package default
     * @uses This function is used to import the csv file data from the feed URL
     */
    function _importStockFeed() {
        ...
        curl_exec($request); // execute curl post and store results in $auth_ticket
        curl_close($request);
    ...
    /**
     * gamemaster_addpreload method
     * This function used for admin
     * @return void
     */
